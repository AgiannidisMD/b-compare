                                                    ...
                                                    <div class="flex-1 min-w-0">
                                                        ...
                                                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 mt-4">
                                                            <div class="score-pill">
                                                                <div class="text-[10px] uppercase tracking-wide mb-1" style="color: var(--warm-gray);">Αποτελεσμ.</div>
                                                                <div class="text-sm font-semibold" style="color: #3b82f6;" x-text="rec.efficacy_score || '-'"></div>
                                                            </div>
                                                            <div class="score-pill">
                                                            ...
                                                            <div class="score-pill">
                                                                <div class="text-[10px] uppercase tracking-wide mb-1" style="color: var(--warm-gray);">Βιοδιαθ.</div>
                                                                <div class="text-sm font-semibold" style="color: #f59e0b;" x-text="rec.bioavailability_score || '-'"></div>
                                                            </div>
                                                            <div class="score-pill">
                                                                <div class="text-[10px] uppercase tracking-wide mb-1" style="color: var(--warm-gray);">Σύνθεση</div>
                                                                <div class="text-sm font-semibold" style="color: #8b5cf6;" x-text="rec.formulation_score || '-'"></div>
                                                            </div>
                                                        </div>

                                                        <!-- Price & Rating -->
                                                        <div class="flex flex-wrap items-center gap-2 sm:gap-4 mt-4 text-xs sm:text-sm">
                                                            <span class="font-semibold" style="color: var(--charcoal);" x-text="rec.price ? '€' + parseFloat(rec.price).toFixed(2) : ''"></span>
                                                            <span class="flex items-center gap-1" style="color: var(--warm-gray);">
                                                                <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4" style="color: var(--gold);" fill="currentColor" viewBox="0 0 20 20">
                                                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                                                </svg>
                                                                <span x-text="rec.rating ? parseFloat(rec.rating).toFixed(1) : '-'"></span>
                                                            </span>
                                                            <span x-show="rec.review_count" class="hidden sm:inline" style="color: var(--warm-gray);" x-text="'(' + rec.review_count + ' κριτικές)'"></span>
                                                        </div>
                                                    </div>
                                                </div>
