...
return [
    ...
    'omega-3-fish-oil' => [
        ...
        'key_ingredients' => ['epa', 'dha', 'omega-3', 'fish oil', 'omega 3'],
    ...
    'vitamin-d' => [
        ...
        'key_ingredients' => ['vitamin d', 'cholecalciferol', 'ergocalciferol', 'd3', 'd2'],
    ...
    'probiotics' => [
        ...
        'key_ingredients' => ['lactobacillus', 'bifidobacterium', 'saccharomyces', 'probiotic', 'cfu', 'bacillus'],
    ...
    'collagen' => [
        ...
        'key_ingredients' => ['collagen', 'peptides', 'hydrolyzed'],
    ...
    'protein-supplements' => [
        ...
        'key_ingredients' => ['protein', 'whey', 'casein', 'pea protein', 'rice protein'],
    ...
    'vitamin-c' => [
        ...
        'key_ingredients' => ['vitamin c', 'ascorbic acid', 'ascorbate', 'ester-c'],
    ...
    'coq10' => [
        ...
        'key_ingredients' => ['coq10', 'ubiquinol', 'ubiquinone', 'coenzyme q10'],
    ...
    'b-vitamins' => [
        ...
        'key_ingredients' => ['b12', 'b-12', 'folate', 'folic', 'b6', 'b1', 'b2', 'b-complex', 'b complex', 'thiamin', 'riboflavin', 'niacin', 'biotin', 'pantothenic'],
        'cofactors' => [],
    ...
    'vitamin-a' => [
        ...
        'key_ingredients' => ['vitamin a', 'retinol', 'retinyl', 'beta-carotene', 'beta carotene'],
    ...
    'iron' => [
        ...
        'key_ingredients' => ['iron', 'ferrous', 'ferric', 'carbonyl iron'],
    ...
    'digestive-enzymes' => [
        ...
        'key_ingredients' => ['protease', 'lipase', 'amylase', 'bromelain', 'papain', 'cellulase', 'lactase', 'dpp-iv'],
    ...
    'amino-acids' => [
        ...
        'key_ingredients' => ['l-glutamine', 'l-theanine', 'l-tyrosine', 'l-carnitine', 'bcaa', 'eaa', 'taurine', 'glycine', 'nac', 'n-acetyl cysteine'],
    ...
    'electrolytes' => [
        ...
        'key_ingredients' => ['sodium', 'potassium', 'magnesium', 'chloride', 'calcium', 'phosphorus'],
    ...
    'joint-support' => [
        ...
        'key_ingredients' => ['glucosamine', 'chondroitin', 'msm', 'hyaluronic', 'boswellia', 'collagen type ii', 'uc-ii', 'turmeric', 'curcumin'],
    ...
    'sleep-support' => [
        ...
        'key_ingredients' => ['melatonin', 'magnesium', 'l-theanine', 'gaba', 'glycine', 'valerian', 'passionflower', 'chamomile', 'apigenin', 'tryptophan', '5-htp'],
    ...
    'herbal-adaptogens' => [
        ...
        'key_ingredients' => ['ashwagandha', 'rhodiola', 'ginseng', 'panax', 'bacopa', 'lion\'s mane', 'reishi', 'cordyceps', 'holy basil', 'tulsi', 'eleuthero', 'maca', 'astragalus', 'milk thistle', 'silymarin', 'turmeric', 'curcumin'],
    ...
    'fiber-supplements' => [
        ...
        'key_ingredients' => ['psyllium', 'fiber', 'inulin', 'glucomannan', 'pectin', 'cellulose', 'acacia', 'guar', 'beta-glucan', 'flaxseed'],
